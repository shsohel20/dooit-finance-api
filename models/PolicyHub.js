...
const PolicyHubSchema = new Schema(
    {
        client: { type: Schema.Types.ObjectId, ref: "Client", required: false, index: true },
        branch: { type: Schema.Types.ObjectId, ref: "Branch", required: false, index: true },
        ...
        versions: [
            {
                ...
                editReason: { type: String, default: "" }, // optional description
            },
        ],
    },
    {
