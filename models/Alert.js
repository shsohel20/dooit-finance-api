...
AlertSchema.index({ "txId.data": 1 });
AlertSchema.index({ "alertId.data": 1 });
AlertSchema.index({ reference: 1 });
AlertSchema.index({ originatorName: 1 });
AlertSchema.index({ beneficiaryName: 1 });
AlertSchema.index({ createdAt: -1 });
AlertSchema.index({ "risk.transactionRiskScore": -1 });
